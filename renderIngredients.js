...
const renderIngredients = product => {
  ...
  <svg class='doodle-down' width="162" height="119" viewBox="0 0 162 119" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <button class="button-shop">Order Now<svg class='doodle-heart' width="99" height="91" viewBox="0 0 99 91" fill="black" xmlns="http://www.w3.org/2000/svg">
